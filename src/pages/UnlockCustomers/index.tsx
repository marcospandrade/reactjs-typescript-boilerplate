...
export function UnlockCustomers() {
    ...
    async function handleUnblockCustomers() {
        ...
        await axios.post('unblock-terminals', params)
            .then(response => {
            ...
            <Grid container spacing={2}>
                ...
                <Grid item xl={12} lg={12} md={12} sm={12} xs={12} className={styles.containerButton}>
                    <Button
                        variant='contained'
                        color="primary"
                        onClick={handleUnblockCustomers}
